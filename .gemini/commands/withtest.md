...
YOUR JOB: Read GEMINI.md, inspect the codebase, find ALL files and code relevant to this task, and write a comprehensive context document.

Steps:
1. Read GEMINI.md for project conventions and build instructions.
...
3. **Code quality**: Will the plan minimize code duplication? Does it follow existing codebase patterns from GEMINI.md?
...
- Follow GEMINI.md coding conventions (no comments except complex algorithms, use auto, empty line before closing brace, etc.)
...
3. If the build fails:
   ...
   c. Fix the errors in accordance with the plan and GEMINI.md conventions
...
- Follow GEMINI.md coding conventions
