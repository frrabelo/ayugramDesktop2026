...
You are setting up a new **repetitive task automation** for Gemini CLI. The goal is to create a folder in `.ai/<featurename>/` containing:
- `prompt.md` - Detailed instructions for the autonomous agent
- `tasks.json` - List of tasks with completion tracking

This pair can then be executed via `.gemini/iterate.ps1 <featurename>`.
