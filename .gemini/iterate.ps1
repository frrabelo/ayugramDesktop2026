...
# Runs Gemini CLI in a loop to complete tasks from a taskplanner-created folder
#
# Usage: .\.gemini\iterate.ps1 <featurename> [-MaxIterations N] [-Interactive] [-DryRun] [-SingleCommit] [-NoCommit]
#
# Arguments:
...
$WorkDir = Join-Path $RepoRoot ".ai\$FeatureName"
